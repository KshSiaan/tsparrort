export const items = [
  ...
  { name: "Original Sugarcane", image: "/image/products/Original Sugarcane.jpg", price: 6.0 },
  { name: "Osmanthus Matcha Cloud", image: "/image/products/Osmanthus Matcha Cloud.jpg", price: 7.5 },
  { name: "Strawberry Delight Souffle", image: "/image/products/Strawberry Delight Souffle.jpg", price: 8.0 },
  { name: "Mango Souffle", image: "/image/products/Mango Souffle.jpg", price: 8.0 },
  { name: "Chocolate Lava Basque Slice", image: "/image/products/Choclate Lava Basque Slice.jpg", price: 7.5 },
  { name: "Original Slice Basque", image: "/image/products/Original Slice Basque.jpg", price: 7.0 },
];
